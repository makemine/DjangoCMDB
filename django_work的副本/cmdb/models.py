...
class BusinessUnit(models.Model):
    ...
    contact = models.ForeignKey('UserGroup',verbose_name='业务线联系人',related_name='c',on_delete=models.CASCADE,)
...
class Asset(models.Model):
    ...
    def __str__(self):
        # return self.idc
        return "%s-%s-%s" % (self.idc, self.cabinet_num, self.cabinet_order)
...
class Server(models.Model):
    ...
    manufacturer = models.CharField(verbose_name='制作商', max_length=64,null=True,blank=True)
...
class Memory(models.Model):
    ...
    manufacturer = models.CharField('制作商', max_length=32, null=True, blank=True)
